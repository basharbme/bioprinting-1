...
G92 E0 ; set position of extruder
;Second Line
G1 X-4.00 Y4.60 Z0.40 F300 ;move to starting location
G1 X2.67 Y4.60 Z0.40 E0.1 ;print first line
G2 X2.67 Y1.93 Z0.40 J-1.93 E0.2 ;print first CW arc
G1 X-2.67 Y0.73 Z0.40 E0.3 ;print next line
G3 X-2.67 Y-0.73 Z0.40 J-0.73 E0.4 ;print CCW arc
G1 X2.67 Y-0.73 Z0.40 E0.5 ;print next line
G2 X2.67 Y-4.00 Z0.40 J-1.93 E0.6 ;print CW arc
G1 X-4.00 Y-4.60 Z0.40 E0.7 ;print last line
G1 Z0.80 ;move above scaffold

G92 E0 ; set position of extruder
;Third Line
G1 X-4.00 Y3.40 Z0.40 F300 ;move to starting location
G1 X2.67 Y3.40 Z0.40 E0.1 ;print first line
G2 X2.67 Y0.73 Z0.40 J-0.73 E0.2 ;print first CW arc
G1 X-2.67 Y1.93 Z0.40 E0.3 ;print next line
G3 X-2.67 Y-1.93 Z0.40 J-1.93 E0.4 ;print CCW arc
G1 X2.67 Y-1.93 Z0.40 E0.5 ;print next line
G2 X2.67 Y-4.00 Z0.40 J-0.73 E0.6 ;print CW arc
G1 X-4.00 Y-3.40 Z0.40 E0.7 ;print last line
G1 Z0.80 ;move above scaffold
