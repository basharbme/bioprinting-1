...
"""
r = 5                             #Radius of spiral [mm]
h = 10                              #Height of spiral [mm]
t = 4                            #Number of turns in spiral
n = 20                              #Number of points per circle

pSpeed = 300                        #Printer speed in [mm/min]


p = h/t                             #pitch, equal to height/number turns [mm]
