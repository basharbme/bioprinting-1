...
n1 = 7                              # Number of grid lines in x direction
n2 = 7                              # Number of grid lines in y direction

layers = 10                          # Number of layers
layspace = 0.25                      # Distance between layers [mm]
...
for layer in range(layers):         # Loop through different layers
    ...
    if (layer % 2) == 0:              # If layer 1,3,5,...
        ...
        f.write('G1 X{:0.2f} Y{:0.2f} Z{:0.2f} E0.2 '
                .format(xinit+deltax1, ytop, zlayer) +
                ';print first connecting line\n')
        ...
        f.write('G1 X{:0.2f} Y{:0.2f} Z{:0.2f} E0.2 '
                .format(xright, yinit-deltax2, zlayer) +
                ';print first connecting line\n')
